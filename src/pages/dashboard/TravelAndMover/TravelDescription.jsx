      ...
      <div className="flex flex-col md:flex-row gap-6 mt-5">
        ...
        <Card className="p-6 border border-gray-300 shadow-sm rounded-2xl w-full max-w-5xl">
          ...
          <form onSubmit={handleDescriptionSubmit} className="grid gap-4">
            ...
            >
              <Option value="0">Itinerary</Option>
              <Option value="1">Tour Info & Policies</Option>
              <Option value="2">Attractions & Activities
              </Option>
              <Option value="3">Package Description
              </Option>
            </Select>
            ...
            {product.description.map((desc, index) => (
              ...
              >
                ...
                {(selectedType === "1" || selectedType === "3" || selectedType==="0") && (
                  <>
